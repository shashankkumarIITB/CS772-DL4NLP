...
class NeuralNet:
    ...
    def train_nn(self, batch_size, epochs):
        ...
        self.model.save('models/Without.h5')
        self.evaluate()
    ...
    def load_nn():
        ...
        return load_model('models/Without.h5', custom_objects={'softmax_activation': softmax_activation})
...
def main(train_file, test_file):    
    ...
    model=NeuralNet(train_reviews, train_ratings, epochs=epochs, batch_size=batch_size)
    model.build_nn()
    model.train_nn()
...
def test_model(test_file):
	...
	y_true, y_pred = true_ratings, predictions
...
if __name__ == '__main__':
    predictions_softmax = main('data/train_balanced.csv', 'data/gold_test.csv')
